...
export default function OtherProjects() {
  return (
    <>
      <div className="container min-h-screen mx-auto px-8 pb-28 pt-56 sm:pt-52 md:pt-28 xl:py-10 max-w-4xl flex flex-col items-center">
        ...
        {/* Button */}
        <Link href="https://github.com/ManishJoc14" target="_blank" className="rounded-md w-max mt-8 border border-secondary p-4 px-6 text-sm tracking-wider text-secondary transition-all hover:-translate-x-1 hover:-translate-y-1 hover:shadow-primary-shadow ">
          Show More
        </Link>
      </div>
    </>
...
function ProjectCard(project: {
  ...
  return (
    <>
      <div key={project.id} className="p-6 bg-primary-light rounded-md">
